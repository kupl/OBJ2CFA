...
public class FactWriter
{
  ...
  public void writeAssignElse(SootMethod m, Local to)
  {
		  _db.add("AssignElse",
...
/*
 public void writePrivateClass(SootClass c)
  {
    String rep = _rep.type(c);
    _db.add("PrivateClass",
      _db.addEntity("ClassType", rep));
  }

 public void writePublicClass(SootClass c)
  {
    String rep = _rep.type(c);
    _db.add("PublicClass",
      _db.addEntity("ClassType", rep));
  ...
  public void writeFinalClass(SootClass c)
  {
    String rep = _rep.type(c);
    _db.add("FinalClass",
      _db.addEntity("ClassType", rep));
