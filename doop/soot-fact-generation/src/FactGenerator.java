...
/////////////////////////////////////////////Minseok
    ...
    if(Modifier.isNative(modifiers))
      _writer.writeClassModifier(c, "native");
    ...
    if(Modifier.isSynchronized(modifiers))
      _writer.writeClassModifier(c, "synchronized");
    if(Modifier.isTransient(modifiers)) 
      _writer.writeClassModifier(c, "transient");
    if(Modifier.isVolatile(modifiers)) 
      _writer.writeClassModifier(c, "volatile");
    // TODO interface?
    // TODO strictfp?
    // TODO annotation?
    // TODO enum?
////////////////////////////////////////////////Minseok 
  ...
  public void generateLeftLocal(SootMethod inMethod, AssignStmt stmt, Session session)
  {
	...
	_writer.writeAssignCast(inMethod, left, (Local) op, cast.getCastType());
      ...
      {
        _writer.writeAssignElse(inMethod, left);
